...
#define lion_MEMCPY __builtin_memcpy
#define lion_MEMSET __builtin_memset
#else
#define lion_MEMCPY memcpy
#define lion_MEMSET memset
#endif
...
#define INVARIANT(expr) lion_ASSERT(expr)
#else
...
// we'll never return
#define lion_UNIMPLEMENTED(what)        \
  do {                                \
    lion_ASSERT(false);                 \
...
#ifdef NDEBUG
#define lion_ASSERT(expr) ((void)0)
#else
#define lion_ASSERT(expr) assert((expr))
#endif /* NDEBUG */
...
#define lion_FALLTHROUGH [[clang::fallthrough]]
#elif defined __GNUC__ && __GNUC__ >= 7
#define lion_FALLTHROUGH [[fallthrough]]
#else
#define lion_FALLTHROUGH
#endif
