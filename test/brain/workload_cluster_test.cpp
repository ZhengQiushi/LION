...
class QueryClustererTests : public lionTest {};
...
TEST(QueryClustererTests, ClusterTest) {
    ...
    lion::brain::workload_data data;
    lion::brain::get_workload_classified(cur_timestamp, last_timestamp, data);
    ...
    lion::brain::onlineClustering(raw_features_, cur_timestamp, last_timestamp, 
                                                                               period_duration , sample_interval, 
                                                                               query_clusterer, data);
    
    std::vector<lion::brain::Cluster*> top_k = lion::brain::getTopCoverage(top_cluster_num, query_clusterer);
